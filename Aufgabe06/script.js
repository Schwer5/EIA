...
const deutschland = document.querySelector('.germany').parentElement;
...
const oesterreich = document.querySelector('.austria').parentElement;
...
const belgien = document.querySelector('.belgium').parentElement;
